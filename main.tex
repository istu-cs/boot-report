...
Кроме того, порой возникает необходимость временного измененияся загрузчики pxelinux (проект syslinux)
и gPXE (проект etherboot).
...
\begin{itemize}
    ...
    \item Не поддерживают PXE: для таких машин требуется установка загрузчика
        ...
        В этом случае сценарий загрузки следующий:
        \begin{enumerate}
            \item BIOS загружает gPXE с жёсткого диска и передаёт ему управление
...
% TODO описание http boot
% TODO описание dhcpd
% TODO описание nfsd

\section{Клиент}

% TODO описание загрузки GNU/Linux
